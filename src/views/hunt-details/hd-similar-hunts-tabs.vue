  ...
  <div>
    <div class="sm:hidden pt-4">
      ...
      <select
        ...
        id="tabs"
        name="tabs"
        class="capitalize block w-full text-base border-gray-300 focus:outline-none focus:ring-olive-500 focus:border-olive-500 sm:text-sm rounded-md"
      >
        <option
...
export default {
  ...
  methods: {
    setHunts () {
      const hunts = this.data.related_hunts
      const data = {}
