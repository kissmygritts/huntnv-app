        ...
        >
          ...
          <div class="pt-5 pb-4">
            <div class="flex-shrink-0 flex items-end px-4">
              ...
              />
              <h1
                class="text-saffron-600 text-xl font-semibold tracking-wider -ml-2"
              >
                HuntNV
              </h1>
            </div>
          ...
          <div
            class="flex-shrink-0 flex items-center justify-center border-t border-gray-200 p-4"
          >
            <a
...
export default {
  ...
  setup() {
    const { visible, close } = useMobileMenu()
